...
Grab_NVD_Vuln_File = "https://nvd.nist.gov/feeds/json/cve/1.0/nvdcve-1.0-2018.json.zip"
...
Security_Products = [u'perl',u'cisco',u'mozilla']
...
with open('c:\TEMP\\nvdcve-1.0-recent.json') as NVDCVE_JSON:
    ...
    for NVDCVE_Current_Count in range(NVDCVE_Row_Count):
        ...
        NVDCVE_Vendor_Data[NVDCVE_Current_Count] = NVDCVE_Info[NVDCVE_Current_Count][u'cve'][u'affects'][u'vendor'] \
            [u'vendor_data']
        try:
            NVDCVE_Vendor_Name[NVDCVE_Current_Count] = NVDCVE_JSON_Data[u'CVE_Items'][NVDCVE_Current_Count][u'cve'][u'affects'][u'vendor'] \
                [u'vendor_data'][0][u'vendor_name']
        except:
        ...
        for product_count in range(len(Security_Products)):
            try:
                ...
                if NVDCVE_Vendor_Name[NVDCVE_Current_Count] == Security_Products[product_count]:
                    ...
                    print "\033[91m" + "\033[1m" + "Description: " + "\033[0m" + (textwrap.fill \
                        (NVDCVE_Info[NVDCVE_Current_Count][u'cve'][u'description'][u'description_data'] \
                        [0][u'value'], 125))
